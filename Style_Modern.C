...
void Style_Modern()
{
   ...
   tmpStyle->SetLabelSize(0.032, "x");
   tmpStyle->SetLabelSize(0.032, "y");
   tmpStyle->SetLabelSize(0.032, "z");
   ...
   tmpStyle->SetTitleSize(0.03, "y");
   tmpStyle->SetTitleSize(0.03, "z");
   ...
   tmpStyle->GetAttDate()->SetTextFont(112);
